...
echo "5️⃣  Pausing new task submissions..."
...
# 8. Resume traffic
echo "8️⃣  Resuming task submissions..."
curl -X POST http://localhost:8000/resume

# 9. Monitor for 5 minutes
echo "9️⃣  Monitoring for stability (5 min)..."
sleep 300
...
graph TD
    ...
    Safety["🛡️ Safety validator approves action"]
...
- [Appendix A: RAG Chatbot Setup](/docs/appendix-a)
- [Appendix B: Free-Tier Deployment Guide](/docs/appendix-b)
- [Appendix C: Urdu Glossary & Localization](/docs/appendix-c)
- [Appendix D: FAQ & Troubleshooting](/docs/appendix-d)
